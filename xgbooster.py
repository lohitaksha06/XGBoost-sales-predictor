...
# Step 2: Predict sales for the next 5 weeks
future_dates = pd.date_range(start=df_sales['date'].max() + pd.Timedelta(days=7), periods=5, freq='W-MON')
...
output_file_path = "Future_Sales_Predictions.csv"
future_data.to_csv(output_file_path, index=False)

# Display the results
print("Predictions for the next 5 weeks:")
